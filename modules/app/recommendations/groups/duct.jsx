...
import {allDuctedSystems} from 'data/formatters/hvacFormatters'

@connectSelector({
  collection: (state, {jobId}) => allDuctedSystems(state.fn.hvacsByJobId(jobId))
})
export default class DuctGroup extends React.Component {
