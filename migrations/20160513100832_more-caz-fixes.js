...
exports.up = function(knex, Promise) {
  return knex.schema.table('v5_caz', (t) => {
    ...
    t.dropColumn('caz_appliance_vent_system_type_improved')
    t.dropColumn('caz_appliance_co_test_result')
    t.dropColumn('caz_appliance_co_test_result_improved')
    t.dropColumn('caz_appliance_flue_test_result')
    t.dropColumn('caz_appliance_flue_test_result_improved')
    t.dropColumn('caz_appliance_spillage_test_result')
    t.dropColumn('caz_appliance_spillage_test_result_improved')
  }).table('v5_caz', (t) => {
